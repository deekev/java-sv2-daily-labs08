...
public class FileReaderFirst {

    public static void main(String[] args) {
        int minTemperature = new FileReaderFirst().findSmallestTemperatureSpread("weather.dat");
        System.out.println(minTemperature);
        String name = new FileReaderFirst().findSmallestTeamDifference("football.dat");
        System.out.println(name);
    }

    private String findSmallestTeamDifference(String filename) {
        try {
            List<String> lines = Files.readAllLines(Paths.get("week08-lab-tasks/src/test/resources/" + filename));
